        ...
        <main className="flex min-h-screen flex-col items-center justify-center bg-neutral-950 p-4 relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-md space-y-6">
                ...
                <div className="text-center space-y-2">
                    <div className="inline-flex items-center justify-center px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-blue-400 text-xs font-medium mb-2">
                ...
                {/* Participants List */}
                <div className="bg-neutral-900/50 backdrop-blur-xl rounded-3xl border border-white/5 flex flex-col overflow-hidden shadow-2xl">
